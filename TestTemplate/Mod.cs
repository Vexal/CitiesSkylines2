...
namespace TestTemplate
{
	...
	{
		public static ILog log = LogManager.GetLogger($"{nameof(TestTemplate)}.{nameof(Mod)}").SetShowsErrorsInUI(false);
		...
		public void OnLoad(UpdateSystem updateSystem)
		{
			...
			AssetDatabase.global.LoadSettings(nameof(TestTemplate), m_Setting, new Setting(this));
		}
